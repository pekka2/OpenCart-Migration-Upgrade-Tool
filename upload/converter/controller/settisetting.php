...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->model_setting_setting->editSettingValue('config', 'config_admin_language',$this->request->post['config_admin_language'],0);
		...
		$this->data['text_admin_language'] = $this->language->get('text_admin_language');
		...
		$this->data['languages'] = $this->model_setting_setting->getLanguages();
