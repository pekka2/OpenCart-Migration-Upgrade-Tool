...
<?php echo $text_simulation; ?> <span class="<?php echo $simulate ? 'green">' . $text_on : 'red">' . $text_off; ?></span>
   ...
   <?php if( isset( $add_columns ) ) { echo $add_columns; } ?>
		...
		<div id="column-left">
<div class="msg round">
		<h2><?php echo $header_step_column; ?></h2>
		<div class="step round"><?php echo $text_step; ?></div>

		<div class="clr"></div>

    <div class="heading">
      <h1><img src="view/image/user.png" alt="" /> <?php echo $text_module_info; ?></h1>
    </div> 
		...
		<div class="block">
			<form action="<?php echo $action; ?>" method="post">
				...
				<div class="buttons">
					<input type="submit" name="submit" value="<?php echo $btn_module; ?>" class="submit round green" />
    ...
    <div id="column-right">
      <ul class="list-group">
        ...
        <li class="list-group-item"><b><?php echo $step_module; ?></b></li>
