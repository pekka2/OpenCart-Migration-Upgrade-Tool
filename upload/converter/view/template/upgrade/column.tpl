...
<div class="msg round">
      ...
      <h1><img src="view/image/user.png" alt="" /> <?php echo $text_column_info; ?></h1>   
		...
		<div class="block">
			<form action="<?php echo $action; ?>" method="post">
				...
				<div class="buttons">
					<input type="submit" name="submit" value="<?php echo $btn_column; ?>" class="submit round green" />
    ...
    <div id="column-right" class="upgrade">   
      <ul class="list-group">
        ...
        <li class="list-group-item"><b><?php echo $step_column; ?></b></li>
